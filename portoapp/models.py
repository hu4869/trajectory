...
class PortoPoints(models.Model):
    ...
    pointgeo = models.PointField(geography=True, srid=0, blank=True, null=True)
...
class PortoStreets(models.Model):
    ...
    streetgeo = models.GeometryField(geography=True, srid=0, blank=True, null=True)
...
class PortoTrips(models.Model):
    ...
    trippoints = models.GeometryField(geography=True, srid=0, blank=True, null=True)
    triplength = models.FloatField(blank=True, null=True)
    starttime = models.DateTimeField(blank=True, null=True)
    endtime = models.DateTimeField(blank=True, null=True)
    startpoint = models.PointField(geography=True, srid=0, blank=True, null=True)
    endpoint = models.PointField(geography=True, srid=0, blank=True, null=True)
